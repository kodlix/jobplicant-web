const CompanyPersonalInfo = ({ componentStatus, toggleEditMode }) => {
  ...
  return (
    <>
      ...
      {!componentStatus.personalInfoEdit && <i className="pi pi-pencil p-pr-3 personalInfo-edit" id="personalInfoEdit" onClick={openEditMode}>&nbsp;<u>(should this be company name only or include contact person details)</u></i>}
      <div>Nigeria</div>
