  ...
  return (
    <>
      <div className="p-card p-mt-2">
        <SectionHeader icon="book" sectionTitle="Education" id="educationEdit" addButton="true" onClick={openEditMode} />
        <span>
          <div className="p-card-subtitle p-ml-3 p-mb-0 mainTitle"><span><b>Msc</b> in <b className="experienceCompany">Arts and Literature</b></span><i className="pi pi-pencil" onClick={openEditMode} id="educationEdit"></i></div>
