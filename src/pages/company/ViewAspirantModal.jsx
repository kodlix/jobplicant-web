...
import { acceptApplicant, viewApplicant } from "store/modules/job";
...
const ViewAspirantModal = ({ showModal, onHide, jobId }) => {
    ...
    const handleAcceptApplicant = (applicantId) => {
        ...
        dispatch(acceptApplicant(applicantId, data));
    }
