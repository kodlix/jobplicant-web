            ...
            <div className="p-col-12 p-md-6 p-px-0">
              <div className="p-card p-grid p-mb-2 p-mt-0 p-mx-0 p-p-3 align-items-center">
                ...
                <div className="p-col-10">
                  ...
                  <ModalMode onHide={onHide} displayModal={displayModal} postId={postId} />
                </div>
              </div>
              <div>
 ...
 */}
                ...
                {posts.map((post) => (
                  <div className="p-card p-p-5 p-mb-2" key={post.id}>
                    <span className="d-flex justify-content-between">
                      <span className="d-flex">
                        ...
                        <span>
                          ...
                          <div className="cardtitle-posttime"><i className="pi pi-clock p-pr-1 p-mt-2"></i>
                            <span>
                              3 min ago
                        </span>
                          </div>
                    ...
                    <div className="p-my-4 w-100 h-100">
                      ...
                      <img src={`${API_ROOT}/${post.postImage}`} height="100%" width="100%" />
