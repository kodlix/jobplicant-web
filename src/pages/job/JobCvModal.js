...
const JobCvCardItem = ({ cvData, jobId, setShowModal }) => {
...
export default ({ cvData, showModal, setShowModal, jobId }) => {
      ...
      {cvData === null ? (
        ...
        <div className="card">
          <div className="card-body">
            <JobCvCardItem cvData={cvData} jobId={jobId} />
          </div>
        </div>
      )}
    </Dialog>
