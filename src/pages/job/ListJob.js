      ...
      <div class="d-flex p-jc-between">
        ...
        <div>
          <Link
            ...
            className="btn btn-sm p-button-info"
          >
            View Job
          </Link>
        </div>
      </div>
      <div class="w-flex-grow-1">
        <p width="" className="p-mb-2">
          {job.companyName}
        </p>
        <div
          style={{
          ...
          <div className="p-col-12 p-md-6">
            {loading ? (
              ...
              <>
                ...
                >
                  <h4 className="ml-4">
                    {jobs?.length > 0 ? jobs?.length : FilterJobs?.length || 0}{" "}
                    matches found
                  </h4>
                </div>
